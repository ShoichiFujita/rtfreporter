...
## 16  Shared table style (R6 theme)

`rtf_table_style$new()` builds a **shared mutable theme** that you can
hand to many tables.  Mutating the theme later affects every table
constructed after the mutation.
...
The R6-vs-S3 design choice is documented in [LEARNING.md](../LEARNING.md).
...
| `col_spec` | list | Per-column align / bold / italic / indent / **border** (R6 rtf_border) / header_* |
...
| `style` | rtf_table_style | Shared R6 theme; provides defaults overridden by explicit args |
